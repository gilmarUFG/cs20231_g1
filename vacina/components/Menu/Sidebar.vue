          ...
          <div v-if="admin">
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Cadastrar vacina</span>
                <span
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Cadastrar alergia</span>
                <span
                  class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                  >3</span
                >
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Cadastrar usuário</span>
                <span
                  class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                  >3</span
                >
